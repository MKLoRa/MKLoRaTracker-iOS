...
@interface MKLTDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKLTDFUModule

- (void)dealloc{
    NSLog(@"MKLTDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKLTCentralManager shared].peripheral];
}
