...
@interface MKLTUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKLTDFUModule *dfuModule;
...
@implementation MKLTUpdateController

- (void)dealloc {
    NSLog(@"MKLTUpdateController销毁");
...
- (MKLTDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKLTDFUModule alloc] init];
    }
    return _dfuModule;
}
