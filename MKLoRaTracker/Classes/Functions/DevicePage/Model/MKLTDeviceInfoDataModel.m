...
@interface MKLTDeviceInfoDataModel ()
...
@implementation MKLTDeviceInfoDataModel
...
- (BOOL)readBatteryPower {
    ...
    [MKLTInterface lt_readBatteryPowerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readMacAddress {
    __block BOOL success = NO;
    [MKLTInterface lt_readMacAddressWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readDeviceModel {
    __block BOOL success = NO;
    [MKLTInterface lt_readDeviceModelWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readSoftware {
    __block BOOL success = NO;
    [MKLTInterface lt_readSoftwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readFirmware {
    __block BOOL success = NO;
    [MKLTInterface lt_readFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHardware {
    __block BOOL success = NO;
    [MKLTInterface lt_readHardwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readManu {
    __block BOOL success = NO;
    [MKLTInterface lt_readManufacturerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
